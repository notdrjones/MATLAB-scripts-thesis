function makeLABFrameVideo(datafolder,videoFlag)
...
brightfieldStack = loadtiff([imagefolder 'brightfield.tiff']);
fluorescenceStack = loadtiff([imagefolder 'Lflatfield_denoised.tif']);
