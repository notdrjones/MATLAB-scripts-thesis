function exportReportSprBVelocity(datafolder)
%UNTITLED Summary of this function goes here
%   Detailed explanation goes here

% Start by getting the folderlist
folderlist = getFoldersAndSubfolders(datafolder);
velocityTypes = {'vxAbsHistoFigure';
    'vxHistoFigure';
    'vxyAbsHistoFigure';
    'vxyHistoFigure';
    'vxyLABAbsHistoFigure'};

for jj=1:length(velocityTypes)
    veltype = velocityTypes{jj};
    ...
    for i=1:nFolders
        ...
        try
            % Open figure
            figurePath = [datafolder folderlist{i} 'results\' veltype '.fig'];
        ...
        if mod(i,9)==0 || i == nFolders
            ...
            set(f,'Color','w');
            export_fig(f,[datafolder 'report' veltype '.pdf'],'-append','-nofontswap','-nocrop');
            clf
            tiledLay = tiledlayout(3,3);
            tiledLay.TileSpacing = 'loose';
            tiledLay.Padding = 'loose';
