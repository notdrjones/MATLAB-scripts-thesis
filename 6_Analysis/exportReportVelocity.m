function exportReportVelocity(datafolder)
...
for i=1:nFolders
    ...
    % Open figure
    figurePath = [datafolder folderlist{i} 'results\velocityHistogram.fig'];
    ...
    if mod(i,9)==0 || i == nFolders
        ...
        set(f,'Color','w');
        export_fig(f,[datafolder 'reportVelocityHistogram.pdf'],'-append','-nofontswap','-nocrop');
        clf
        tiledLay = tiledlayout(3,3);
        tiledLay.TileSpacing = 'loose';
        tiledLay.Padding = 'loose';
