function exportReportSprBPosition(datafolder)
...
for i=1:nFolders
    ...
    % Open figure
    try
    figurePath = [datafolder folderlist{i} 'results\sprBPositionHistogram.fig'];
    ...
    if mod(i,9)==0 || i == nFolders
        ...
        set(f,'Color','w');
        export_fig(f,[datafolder 'reportSprBPositionHistogram.pdf'],'-append','-nofontswap','-nocrop');
        clf
        tiledLay = tiledlayout(3,3);
        tiledLay.TileSpacing = 'loose';
        tiledLay.Padding = 'loose';
